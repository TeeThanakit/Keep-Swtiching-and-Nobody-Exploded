...
namespace eval ::optrace {
  variable script "D:/Study/CPE 222/verilog_Led_game/LED GAME/LED GAME.runs/synth_1/top_module.tcl"
...
read_verilog -library xil_defaultlib {
  ...
  {D:/Study/CPE 222/verilog_Led_game/LED GAME/LED GAME.srcs/sources_1/new/debouncedbutton.v}
...
set_property used_in_implementation false [get_files {{D:/Study/CPE 222/verilog_Led_game/LED GAME/LED GAME.srcs/constrs_1/new/Basys3_verilog_led.xdc}}]

set_param ips.enableIPCacheLiteLoad 1

read_checkpoint -auto_incremental -incremental {D:/Study/CPE 222/verilog_Led_game/LED GAME/LED GAME.srcs/utils_1/imports/synth_1/top_module.dcp}
